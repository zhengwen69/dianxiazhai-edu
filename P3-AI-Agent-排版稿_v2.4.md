...
为此，本研究依据上述方案执行了Round 1专家走查。邀请了9位同行参与设计原则审查，其中6位为工科研究生课程教师（来自环境、土木、材料等专业）、2位为在读研究生、1位为教育技术方向研究人员。评估采用七点Likert量表，七个维度分别为：Q1表述清晰性、Q2完备性、Q3可操作性、Q4差异化价值、Q5问题对应性、Q6可迁移性、Q7发表价值（Cronbach's α = .81，表明评估者间信度良好）。

**表3 设计原则专家评估结果（N=9）**

| 评估维度 | Mean | SD | Min | Max |
|------|:--:|:--:|:--:|:--:|
| Q1 表述清晰性 | 6.4 | 1.3 | 3 | 7 |
| Q2 完备性 | 6.2 | 0.7 | 5 | 7 |
| Q3 可操作性 | 6.3 | 0.5 | 6 | 7 |
| Q4 差异化价值 | 6.4 | 0.7 | 5 | 7 |
| Q5 问题对应性 | 6.0 | 0.9 | 5 | 7 |
| Q6 可迁移性 | 6.7 | 0.5 | 6 | 7 |
| Q7 发表价值 | 6.2 | 0.7 | 5 | 7 |
| **整体均值** | **6.3** | **0.8** | | |

九位专家对设计原则的整体评价为6.3±0.8分（满分7分），表明三条原则在清晰性、完备性、可操作性和学术价值方面获得了较为一致的认可。其中Q6（可迁移性）得分最高（6.7），Q5（问题对应性）得分相对最低（6.0）。一位在读研究生对Q1给出最低分3分，其反馈为："每个字都认识，连在一起有点看不懂"，特别是"原则一和缺陷一（碎片化）的对应关系感觉缺了点"。这一反馈提示设计原则的表述在面向非本课程直接参与者的可理解性方面仍有提升空间，已在§3.7局限性中予以讨论。
